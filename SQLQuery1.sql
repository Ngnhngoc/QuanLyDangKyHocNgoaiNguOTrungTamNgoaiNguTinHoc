...
-- 1. Nạp danh mục môn học (Ngôn ngữ)
INSERT INTO DANHMUCNN (MADANHMUC, TENDANHMUC) VALUES 
('TA', N'Tiếng Anh'),
('TN', N'Tiếng Nhật'),
('TH', N'Tiếng Hoa'),
('TP', N'Tiếng Pháp');
...
INSERT INTO QUAN_TRI (TenDangNhap, MatKhau, HoTen, Email)
VALUES ('admin', '123456', N'Quản Trị Hệ Thống', 'ngocsummer0309@tvu.edu.vn');
GO
